...
describe('StatementsService Suite Tests', () => {
  ...
  it('should return expected value after checking a conditional statement | part 2', () => {
  ...
  it('should return expected value after checking a multiple conditional statement', () => {
  ...
  it('should return expected value after checking a multiple conditional statement | part 2', () => {
    const a = 'first string';
    const b = 'second string';
    const c = 'third string';
